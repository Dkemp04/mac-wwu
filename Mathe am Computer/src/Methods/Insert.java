...
public class Insert extends Method
{
	...
	{	return "Die Nearest-Insertion-Heuristik (NEARIN), ist eine Einf¸ge-Heuristik und damit ein heuristisches Erˆffnungsverfahren aus der Graphentheorie. Es dient zur Approximation einer guten Lˆsung des Problem des Handlungsreisenden; Ziel ist es also, eine mˆglichst kurze Rundreise durch alle Knoten des Graphen zu finden.";}
}
